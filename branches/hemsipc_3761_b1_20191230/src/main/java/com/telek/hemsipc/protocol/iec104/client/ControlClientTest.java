 ...
 * @Remarks：        
 */
public final class ControlClientTest {
    private static final Logger LOG = Logger.getLogger(ControlClientTest.class);
    private static String host = "192.168.3.3";
            ...
            try {
                ...
                case M_ME_NC_1:
                    ...
                    for(InformationObject informationObject : infos) {
                        informationObject.getInformationObjectAddress();//获取信息地址
